...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ClientUI_t, stringdata) + ofs \
...
const QMetaObject ClientUI::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ClientUI.data,
      qt_meta_data_ClientUI,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ClientUI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ClientUI.stringdata))
