...
#include "../../ServerAPP/connectclient.h"
...
QT_MOC_LITERAL(3, 29, 26) // "on_pushButton_send_clicked"

    },
    "ConnectClient\0slotReadyRead\0\0"
...
const QMetaObject ConnectClient::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ConnectClient.data,
      qt_meta_data_ConnectClient,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ConnectClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ConnectClient.stringdata0))
        return static_cast<void*>(const_cast< ConnectClient*>(this));
